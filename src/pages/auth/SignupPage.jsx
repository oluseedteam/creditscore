...
const perks=['Monthly credit score tracking','AI-powered coaching cards','Class attendance monitoring','Gamified loan gateway']
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try { signup(form.name,form.email,form.password); navigate('/dashboard') }
    ...
    <div className="min-h-screen flex" style={{background:'#F9F5EF'}}>
      <div className="hidden lg:flex flex-col justify-between w-5/12 p-12 relative overflow-hidden" style={{background:NAVY}}>
        ...
        <Link to="/" className="flex items-center gap-3 relative z-10">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{background:TEAL}}>
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none"><path d="M10 2L17 6.5V13.5L10 18L3 13.5V6.5L10 2Z" stroke="white" strokeWidth="1.5" fill="none"/><circle cx="10" cy="10" r="2.5" fill="#2FBF71"/></svg>
          </div>
        ...
        <div className="relative z-10">
          <h2 className="font-display text-4xl font-bold text-white leading-tight mb-8">
            Your home is<br/><span className="text-gradient-teal">within reach.</span>
          </h2>
        ...
        <div className="relative z-10 rounded-2xl p-6" style={{background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)'}}>
          <p className="text-sm italic font-display mb-4" style={{color:'rgba(255,255,255,0.75)'}}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs" style={{color:'#4db2b2'}}>Now a homeowner</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-up">
          ...
          <h1 className="font-display text-3xl font-bold mb-1" style={{color:NAVY}}>Create your account</h1>
          <p className="mb-8" style={{color:'#6B7280'}}>Start your journey to homeownership today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass?'text':'password'} required className="input-field pr-12" placeholder="At least 6 characters"
